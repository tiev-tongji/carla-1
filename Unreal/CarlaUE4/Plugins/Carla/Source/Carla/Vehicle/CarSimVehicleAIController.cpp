...
#include "Carla.h"
#include "CarSimVehicleAIController.h"
...
//已在WheeledVehicleAIController中定义
...
static bool IsThereAnObstacleAhead(
	const ACarlaCarSimVehicle &Vehicle,
	const float Speed,
...
ACarSimVehicleAIController::ACarSimVehicleAIController(const FObjectInitializer &ObjectInitializer)
...
ACarSimVehicleAIController::~ACarSimVehicleAIController() {}

// =============================================================================
// -- APlayerController --------------------------------------------------------
// =============================================================================

void ACarSimVehicleAIController::Possess(APawn *aPawn)
{
	Super::Possess(aPawn);
	...
	Vehicle = Cast<ACarlaCarSimVehicle>(aPawn);
...
void ACarSimVehicleAIController::UnPossess()
{
	Super::UnPossess();
...
void ACarSimVehicleAIController::Tick(const float DeltaTime)
{
...
void ACarSimVehicleAIController::ConfigureAutopilot(const bool Enable)
{
...
void ACarSimVehicleAIController::SetFixedRoute(
...
void ACarSimVehicleAIController::TickAutopilotController()
{
...
float ACarSimVehicleAIController::GoToNextTargetLocation(FVector &Direction)
{
...
float ACarSimVehicleAIController::CalcStreeringValue(FVector &direction)
{
	float steering = 0;
...
float ACarSimVehicleAIController::Stop(const float Speed)
{
	return (Speed >= 1.0f ? -Speed / SpeedLimit : 0.0f);
}

float ACarSimVehicleAIController::Move(const float Speed)
{
	if (Speed >= SpeedLimit)
	{
		return Stop(Speed);
