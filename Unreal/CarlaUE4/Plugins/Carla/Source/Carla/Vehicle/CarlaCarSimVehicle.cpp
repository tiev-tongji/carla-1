...
float ACarlaCarSimVehicle::GetVehicleForwardSpeed() const
{
	return GetCarSimMovement()->GetForwardSpeed();
}

FVector ACarlaCarSimVehicle::GetVehicleOrientation() const
{
	return GetVehicleTransform().GetRotation().GetForwardVector();
}

int32 ACarlaCarSimVehicle::GetVehicleCurrentGear() const
{
	return GetCarSimMovement()->GetCurrentGear();
}

FTransform ACarlaCarSimVehicle::GetVehicleBoundingBoxTransform() const
{
	return VehicleBounds->GetRelativeTransform();
}

FVector ACarlaCarSimVehicle::GetVehicleBoundingBoxExtent() const
{
	return VehicleBounds->GetScaledBoxExtent();
}

float ACarlaCarSimVehicle::GetMaximumSteerAngle() const
{
...
void ACarlaCarSimVehicle::FlushVehicleControl()
{
...
void ACarlaCarSimVehicle::SetThrottleInput(const float Value)
{
...
void ACarlaCarSimVehicle::SetSteeringInput(const float Value)
{
	FVehicleControl Control = InputControl.Control;
	Control.Steer = Value;
	ApplyVehicleControl(Control, EVehicleInputPriority::User);
...
void ACarlaCarSimVehicle::SetBrakeInput(const float Value)
{
	FVehicleControl Control = InputControl.Control;
	Control.Brake = Value;
	ApplyVehicleControl(Control, EVehicleInputPriority::User);
...
void ACarlaCarSimVehicle::SetReverse(const bool Value)
{
	FVehicleControl Control = InputControl.Control;
...
void ACarlaCarSimVehicle::SetHandbrakeInput(const bool Value)
{
	FVehicleControl Control = InputControl.Control;
...
FVehiclePhysicsControl ACarlaCarSimVehicle::GetVehiclePhysicsControl()
{
...
void ACarlaCarSimVehicle::ApplyVehiclePhysicsControl(const FVehiclePhysicsControl &PhysicsControl)
{
	UCarSimMovementComponent *Vehicle4W =
		CastChecked<UCarSimMovementComponent>(GetCarSimMovement());
